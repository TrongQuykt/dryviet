  ...
  return (
    <div className="w-full bg-white py-24 border-t border-gray-100">
      <div className="container-xl text-center mb-16">
         <span className="text-brand-800 font-black tracking-[0.4em] uppercase text-xs">Product Details</span>
         <div className="w-12 h-1 bg-brand-800 mx-auto mt-6 mb-8" />
         <h2 className="text-4xl md:text-5xl font-medium text-gray-900 font-display italic">Khám Phá Chất Lượng</h2>
